...
- **`.pl-header`** (min 48px): plugin name (`--pl-font-header`, 1.125rem,
  600) · context control (for Money: account switcher; "source chips" in the
...
designs can adopt this without changing their markup. Contrast (≥4.5:1 on
`#fff` and `#000`) is not measured yet; the accessibility issue does that.

...
> by `claude/remove-notion-code`). Paths below are atomic-server paths as of
> 2026-09-06; most of that code has since been removed there. The current plan
> is `../README.md` and issue #8.

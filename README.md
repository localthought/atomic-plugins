...
| 🗓️ **Google Calendar**               | Import one Google calendar's single (non-recurring) events into a table, and send reviewed edits of five fields back with `If-Match`. | Drive app over the host relay; mock-tested in a host e2e, not live-verified                                                         | [`integrations/calendar/`](integrations/calendar/)                                                         | [#94](https://github.com/ontola/atomic-plugins/issues/94) (install), live verification ([#101](https://github.com/ontola/atomic-plugins/issues/101))                          |

...
| 🗓️ **Google Calendar** (Devonian) | Import single (non-recurring) Google Calendar events into calendar views, and preview edits to send back. | [`integrations/calendar/`](integrations/calendar/), [`devonian/platform-lenses/google-calendar/`](devonian/platform-lenses/google-calendar/) | coming — [#52](https://github.com/ontola/atomic-plugins/issues/52), [#51](https://github.com/ontola/atomic-plugins/pull/51) |
...
| 🐙 **GitHub issues** (Devonian lens) | Maps GitHub issues and comments to and from Atomic issue-tracker resources. No catalog card; no host UI since atomic-server#1612. | [`devonian/platform-lenses/github-issues/`](devonian/platform-lenses/github-issues/), [`integrations/issue-tracker/`](integrations/issue-tracker/) | coming — [#9](https://github.com/ontola/atomic-plugins/issues/9) |
